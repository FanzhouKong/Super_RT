...
def calculate_tanimoto(mol1, mol2):
    ...
    fingerprint1 = AllChem.GetMorganFingerprintAsBitVect(mol1, 2, nBits=1024)
    fingerprint2 = AllChem.GetMorganFingerprintAsBitVect(mol2, 2, nBits=1024)

    # Calculate Tanimoto similarity
    tanimoto_similarity = TanimotoSimilarity(fingerprint1, fingerprint2)
...
def everything_to_image(molecule, savepath=None):
    from rdkit import Chem
